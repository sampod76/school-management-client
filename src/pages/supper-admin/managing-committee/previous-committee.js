import PreviousCommitteeTable from "@/components/super-admin-dashboard/managing-committee/previous-committee/previous-committee-table";
...
const PreviousManagingCommittee = () => {
  // state for filter
  ...
  return (
    <>
      <h3 className="text-2xl font-bold m-4">
        ম্যানেজিং কমিটি'র পূর্ববর্তী সদস্য
      </h3>
      ...
      <PreviousCommitteeTable />
    </>
  );
};

export default PreviousManagingCommittee;
