...
const TestimonialsAndPrinting = () => {
  ...
  const handleDownloadPdf = async () => {
    const pdfLink =
      "https://drive.google.com/file/d/1RHYCQL4oJdfyqxOEyeLpLez1ttFEW4Gp/view?usp=sharing"; // Replace with your actual PDF link

    const link = document.createElement("a");
    link.href = pdfLink;
    link.target = "_blank";
    link.rel = "noopener noreferrer";
    link.download = "Testimonial.pdf"; // Specify the desired filename
  ...
  const columns = [
    ...
    },
    {
      ...
      render: (_, record) => (
        <Button
          href="../../../assets/pdf/testimonial.pdf"
  ...
  return (
    <div className="m-3">
      ...
      <div className="flex mx-2 my-2 justify-between">
        <div>
          <h2 className="text-2xl">শিক্ষার্থী প্রশংসাপত্র ও মুদ্রণ</h2>
        </div>
        <div
          onClick={showModal}
