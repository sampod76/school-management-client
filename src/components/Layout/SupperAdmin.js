...
function SupperAdminLayout({ children }) {
  ...
  const allItems = supperadminItem.map((item, i) => (
    <li key={i}>
      {!item.children ? (
        <Link
          href={item.href}
    ...
    <section className="max-w-[2500px] mx-auto ">
      <div className="bg-gray-100">
        ...
        <div className="hidden lg:fixed lg:inset-y-0 lg:z-40 lg:flex lg:w-72 lg:flex-col shadow-lg">
          <div className="flex grow flex-col gap-y-5 overflow-y-auto  scrollbar-none bg-gray-50 px-6 py-4">
            <div className="flex h-16 shrink-0 items-center mt-4 justify-center my-2">
              <Image
                // className="h-8 w-auto"
                height={100}
                width={100}
          ...
          <div className="sticky top-0 z-20 flex h-16 shrink-0 items-center gap-x-4 border-b border-gray-200 bg-gray-50 px-4 shadow-sm">
            ...
            <div className="flex justify-between flex-1 gap-x-4 self-stretch lg:gap-x-6">
              <nav
                ...
                aria-label="Global"
              >
                {/* {supperadminNavbarItem.map((item,i) => (
                  <Link
                    key={i}
                    href={item.href}
                    onClick={() => {
                ...
                <h1 className="text-right font-bold text-2xl px-5 mt-2 ">
                  হাজী আবুবকর সিদ্দিক আদর্শ উচ্চ বিদ্যালয়
                </h1>
              </nav>
                    ...
                    <Menu.Button className="-m-1.5 flex items-center p-1.5">
                      ...
                      <ImageTag
                        data={{
                          ...
                          url: "https://i.ibb.co/kgG7ztc/3135715.png",
                          alt: "proe",
                        }}
                      />
